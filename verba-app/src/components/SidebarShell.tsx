        ...
        <Link href="/dashboard" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
          <div className="flex items-center space-x-3 mb-1">
            ...
            <div className="flex flex-col">
              <span className="text-white font-black text-[22px] leading-none tracking-widest mt-1">VERBA</span>
              <span className="text-[#8CA4CA] text-[11px] font-medium leading-tight mt-1">Write with evidence.</span>
            </div>
          </div>
        </Link>
      </div>
