-- H6 Phase 4 Patch: Fix create_or_get_source source_identifiers schema mismatch
    ...
    ELSE
        ...
        IF jsonb_typeof(p_source_data->'identifiers') = 'array' THEN
            ...
            LOOP
                ...
                INSERT INTO public.source_identifiers (source_id, identifier_type, identifier_value, normalized_value)
                VALUES (
                    v_source_id, 
